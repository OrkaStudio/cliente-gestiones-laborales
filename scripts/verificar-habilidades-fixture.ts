...
import { derivarHabilidadesPorPistas, HABILIDADES_GL } from "../src/lib/cv/habilidades";
...
console.log(
  `Promedio de habilidades por candidato: ${(totalHabPorCand.reduce((a, b) => a + b, 0) / conCv.length).toFixed(1)}`,
);
