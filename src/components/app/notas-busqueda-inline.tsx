...
import { updateBusquedaNotas } from "@/lib/actions/busquedas"
...
export function NotasBusquedaInline({ busquedaId, notas: initial }: Props) {
  ...
  function save() {
    ...
    setEditing(false)
    startTrans(async () => {
      await updateBusquedaNotas(busquedaId, value)
      setSaveOk(true)
      ...
      {editing ? (
        <div className="flex flex-col gap-3">
          <textarea
            ...
            rows={5}
            autoFocus
            placeholder="Presupuesto acordado, sueldo ofrecido, datos del cliente, recordatorios..."
        ...
        <p
          className="text-sm leading-relaxed pl-4 cursor-text whitespace-pre-wrap"
